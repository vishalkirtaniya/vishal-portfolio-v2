...
const Nav = () => {
  return (
    <div className=" h-full w-full flex justify-center ">
      <nav className="flex montserratFont items-center justify-between  w-[90%] container h-[6vh] max-w-[1383px] bg-bgblack ">
        ...
        <div className="h-full w-4/5 flex items-center justify-end ">
          <div className="h-full w-[100px] ">
            <div className="rightSideButton h-full w-full flex justify-end items-center ">
              <div className="h-[20px] w-[30px]  flex flex-col justify-between items-center ">
